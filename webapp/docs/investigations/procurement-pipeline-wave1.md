...
## 1. NATIONAL BUDGET OVERVIEW (2024)

- **Total gasto devengado 2024:** 93.9% execution rate
- **Gastos totales cayeron 25.9% real** year-over-year
- **Superavit primario:** $8.22 billones (1.4% PBI)
- **Deficit financiero:** $1.12 billones (0.2% PBI)
- **Top partidas:** Capital Humano > Servicio de Deuda > Economia

Sources:
- [OPC Ejecucion Presupuestaria 2024](https://opc.gob.ar/ejecucion-presupuestaria/ejecucion-mensual-base-devengado/analisis-de-la-ejecucion-presupuestaria-de-la-administracion-nacional-2024/)
...
| Metric | Value | Period |
|--------|-------|--------|
| Contratacion directa share | 67% → 74.4% | 2003-2006 trend |
| Contratacion directa share (provincial) | >80% | Some provinces |
| CD growth rate | +44.9% | 2017-2018 |
| Licitacion publica growth | +14.3% | 2017-2018 |
| Perception: corruption in contracting | 94% of contractors | Poder Ciudadano survey |
| Cleaning contracts concentration | 10 of 355 firms = 61.78% of total | SIGEN audit |
...
## 3. HEALTH PROCUREMENT PIPELINE

### 3A. PAMI
- **Budget share:** ~80% goes to medication and high-complexity treatments
- **Deficit:** 22% (2024)
- **Key reform:** Direct-to-home delivery, est. savings $5,000M/year
- **Known markup:** 14.3x over reference price (from existing graph data)

### 3B. ANDIS (Agencia Nacional de Discapacidad)
- **Total budget 2024:** ARS $4.83 billones (largest decentralized organism)
- **Budget increase:** +176% (exceeding inflation)
- **DNU reinforcements:** ARS $2.25 billones for medications
- **Budget distribution:** 82% pensions, 17.6% Incluir Salud program
- **CORRUPTION CASE: Suizo Argentina SA**
  - 2024 contracts: ARS $3,898M
  - 2025 contracts: ARS $108,299M (+2,678% increase)
  - >600 contracts under judicial investigation for overpricing
  - Audio recordings implicate system of 8% returns (coimas)
  - Alleged beneficiaries: Karina Milei, Eduardo "Lule" Menem
  - Beneficial owners: Eduardo Kovalivker + sons Emmanuel & Jonathan
  - Also holds PAMI contracts worth >$100B in <2 years
  - 9 provinces also contract with Suizo: ~$50,000M

### 3C. Ministry of Health
- **2025 budget items:**
  - Vaccines: ARS $356,000M
  - Antiretrovirals/hepatitis/TB: ARS $40,000M
  - REMEDIAR program: ARS $66,000M
  - DINADIC high-cost drugs: ARS $115,000M
...
## 4. INSURANCE PIPELINE (Nacion Seguros / Broker Network)

### Structure
```
Decreto 823/2021 (Alberto Fernandez)
  → Mandated all state entities use Nacion Seguros
  → Brokers selected by each organism (not by Nacion Seguros)
  → 27 brokers identified as intermediaries
  → Decreto abrogated by Decreto 747/2024 (Milei)
```

### Money Flow
| Entity | Commissions | Period |
|--------|------------|--------|
| Bachellier SA (Martinez Sosa) | ARS $1,665M | 2021-2023 |
...
### Judicial Status
- Judge: Julian Ercolini (Federal)
- Raids conducted on broker offices (April 2024)
- Companies processed/charged
...
- **Breakdown:** ARS $360,000M to electricity generators + ARS $240,000M to gas producers
- **Resolution:** Government offered AE38 bond with 50% haircut
- **Key generators:** Pampa Energia ($133B debt), Central Puerto, AES, YPF Luz, Enel, Albanesi, Genneia
- **Companies that accepted bond:** Central Puerto, Pampa Energia, Genneia

### Subsidy Recipients (Demand Side)
- Residential: households below 3x Canasta Basica Total
- Bonification: 50-55.94% of consumption
- Gas cobrabilidad: 96% average across distributors
...
## 6. DEFENSE PROCUREMENT PIPELINE

### Budget
- **2025 total defense + security:** USD ~$6,200M (5.1% of total budget)
- **Defense only:** ARS $2.81 billones (~USD $2,200M)
- **July 2024 DNU increase:** +101% (USD $1,900M additional credit)

### Major Acquisitions
| Item | Cost | Supplier/Origin |
|------|------|-----------------|
| 24x F-16 fighters | USD $301.2M (5 annual payments) | Denmark/USA |
| Submarines (Scorpene/209NG) | USD $2,310M loan (3 years) | Naval Group (FR) / TKMS (DE) |
| 2x Frigates | USD $1,400M loan | TBD |
| Naval helicopters | USD $98M (3 years) | TBD |
| VCBR 8x8 armored vehicles | ARS $380,097M (2025-2027) | TBD |
| Medium helicopters | ARS $657,422M (to 2027) | TBD |

### TANDANOR (State Shipyard)
...
- **Status:** Converted to SAU (Nov 2024) under DNU 70-2023, privatization path
- **Interested parties:** CGS Defence (Czech, NATO supplier), Hispania Group (Spain)
- **Previous contract cut:** Orica (Peru) mastermix explosive supply terminated by Milei
...
## 7. PUBLIC WORKS PIPELINE

### Budget Collapse
- **2024 execution:** ARS $59,000M of $247,000M authorized = **24% execution**
- **Construction sector decline:** -29.5% (Jan-Sep 2024)
- **Firms destroyed:** ~4,000 construction companies
- **Jobs lost:** ~80,000 (est.)
- **Debt to constructors:** ~ARS $400,000M (Camarco claim)
...
- **Companies bidding:** 15 firms competing for Buenos Aires/La Pampa corridors
...
## 8. KEY CONTRACTOR NETWORKS (MILEI ERA)

### 8A. OCP Tech / Leonardo Scatturice Network
```
COC Global Enterprise LLC (umbrella)
  ├── OCP Tech S.A.
  ├── OCP Tech Global IT
  ├── OCP Digital Tech Partners
  ├── MDELM LLC
  ├── Tactic Global LLC (SIDE lobbying)
  ├── Surjet
  ├── CPAC Argentina Inc
  └── Fly Bondi (~$400M acquisition)
```
- **State contracts:** 21+ since Milei inauguration (17 via OCP Tech)
- **Clients:** ARCA, Secretaria General (Karina Milei), Min. Economia (Caputo), Min. Publico Fiscal
- **Largest single contract:** USD $6.3M+ IVA (Operadora Ferroviaria, WiFi equipment)
- **SIDE link:** Tactic Global LLC, $10,000/month for Milei-Trump liaison
- **Trump network:** Caroline Wren (fundraiser), Ryan Coyne (Starboard digital fundraising)
- **Admin processes:** 260+ with national state

### 8B. Suizo Argentina SA / Kovalivker Family
```
Suizo Argentina SA
  ├── Eduardo Kovalivker (shareholder)
  ├── Emmanuel Kovalivker (shareholder)
  └── Jonathan Kovalivker (shareholder)
```
- **ANDIS contracts:** 600+ under investigation
- **Growth:** $3,898M (2024) → $108,299M (2025) = +2,678%
- **Also contracts with:** PAMI, 9 provincial governments (~$50,000M)
- **Alleged kickback:** 8% returns to officials (audio evidence)
...
│
├── HEALTH (~$4.83T ANDIS + PAMI + MinSalud)
│   ├── ANDIS → Suizo Argentina ($108B, +2678%) → Kovalivker family
│   │          └── alleged 8% kickbacks → Karina Milei / Lule Menem
│   ├── PAMI → Suizo Argentina (additional $100B+)
│   │        → pharma distributors (80% of PAMI budget)
│   └── MinSalud → REMEDIAR ($66B), vaccines ($356B), DINADIC ($115B)
│
├── INSURANCE (Decreto 823 pipeline, now abrogated)
│   └── All state agencies → Nacion Seguros → 27 brokers
│       ├── Bachellier/Martinez Sosa ($1,665M + $366M = 42% share)
│       ├── Castello Mercuri, San Ignacio, TG Broker
│       └── Total: $3,500M commissions (2020-2023)
│
├── ENERGY SUBSIDIES ($7,024M USD in 2024)
│   └── State → CAMMESA → generators (Pampa, Central Puerto, AES, YPF Luz)
│       └── $2,000M+ unpaid → resolved via AE38 bond (50% haircut)
│
├── DEFENSE ($2,200M USD + $1,900M DNU increase)
│   ├── F-16 purchase ($301M) → Denmark/USA
│   ├── Submarines ($2,310M) → Naval Group / TKMS
│   ├── TANDANOR: $23M paid, 0 boats delivered
│   └── Fabricaciones Militares → privatization → CGS Defence / Hispania
│
├── PUBLIC WORKS (collapsed: 24% execution)
│   ├── Vialidad Nacional ($1T+) → 15 companies bidding for concessions
│   └── Debt to constructors: ~$400,000M (bond proposed)
│
└── IT/SERVICES (contratacion directa dominant)
    └── OCP Tech/Scatturice ($6.3M+ single contract, 21+ total)
        ├── Secretaria General (Karina Milei)
        ├── Min. Economia (Caputo)
        └── SIDE → Tactic LLC → Trump network
```

---

## 10. GRAPH INGESTION CANDIDATES

New nodes to add to caso-finanzas-politicas:

### Persons
- Hector Martinez Sosa (broker, Alberto Fernandez secretary's husband)
- Eduardo Kovalivker (Suizo Argentina owner)
- Emmanuel Kovalivker (Suizo Argentina)
- Jonathan Kovalivker (Suizo Argentina)
- Leonardo Scatturice (OCP Tech CEO, Trump nexus)
- Diego Spagnuolo (ex-ANDIS director, audio evidence)
- Caroline Wren (Trump fundraiser)
- Ryan Coyne (Starboard CEO)
- Eduardo "Lule" Menem (official, implicated in ANDIS)

### Organizations
- Suizo Argentina SA
- Bachellier SA
- Castello Mercuri SA
- San Ignacio Sociedad de Productores
- Torres Garcia Brokers
- OCP Tech SA
- OCP Tech Global IT
- COC Global Enterprise LLC
- Tactic Global LLC
- MDELM LLC
- Nacion Seguros SA
- CAMMESA
...
- PAMI
- TANDANOR
- Fabricaciones Militares SAU
- Pampa Energia
- Central Puerto
- Genneia
- CGS Defence (Czech Republic)

### Events
- Decreto 823/2021 (insurance mandate)
- Decreto 747/2024 (insurance mandate abrogation)
- ANDIS audio leak (Spagnuolo recordings)
- TANDANOR tugboat contract (Sept 2021)
- F-16 purchase agreement
- Submarine loan agreements

### Relationships to create
- Martinez Sosa → CONTROLS → Bachellier SA
- Martinez Sosa → MARRIED_TO → [Alberto Fernandez secretary]
- Kovalivker → OWNS → Suizo Argentina
- Suizo Argentina → CONTRACTED_BY → ANDIS
- Suizo Argentina → CONTRACTED_BY → PAMI
- Scatturice → CONTROLS → OCP Tech
- Scatturice → CONTROLS → COC Global Enterprise
- OCP Tech → CONTRACTED_BY → Secretaria General
- OCP Tech → CONTRACTED_BY → Min. Economia
- Tactic LLC → CONTRACTED_BY → SIDE
- CAMMESA → OWES → Pampa Energia
- CAMMESA → OWES → Central Puerto
