# Judicial Persons & Claims Verification Report

**Date:** 2026-03-21
**Method:** WebSearch verification of each person and specific claim against public sources
**Status:** 15 claims checked
...
LA NACION investigation confirmed:

- Lijo resides on the 5th floor of a luxury building on Avenida Alvear at Ayacucho.
- The property belongs to former ambassador Carlos Bettini (close to Cristina Kirchner).
- Market value: approximately USD 2,000,000.
- Estimated rental: USD 5,000-7,000/month.
- The property does NOT appear in Lijo's sworn asset declaration (DDJJ) because it is registered under Bettini's name.
...
October 2022 scandal confirmed. Key details:

- **Judges on the flight:** Julian Ercolini, Carlos Mahiques, Pablo Cayssials, Pablo Yadarola.
- **Also present:** Juan Bautista Mahiques (head prosecutor CABA), security minister Marcelo D'Alessandro, digital strategist Tomas Reinke, ex-AFI legal chief Leonardo Bergroth.
- **Clarin Group representatives:** Jorge Rendo (president) and Pablo Casey (legal affairs director).
- **Destination:** Joe Lewis's mansion at Lago Escondido, Patagonia.
- **Flight paid by:** Clarin Group.
- **Cover-up:** Telegram chat leaked from D'Alessandro's hacked phone showed coordination to hide the trip.
...
Judge Ercolini dismissed charges against Rogelio Frigerio (ex-Interior Minister under Macri) in a case involving:

- **The property:** Fitz Roy 851, Buenos Aires, adjudicated to company Koolhaas S.A. in a public auction (June 2017).
- **Allegation:** Frigerio signed an Administrative Decision transferring a state-owned property to Koolhaas S.A. while its executives (Gustavo Esses, Ariel Naistat) had commercial ties to Frigerio.
- **Ercolini's ruling:** Agreed with the prosecutor to close the case definitively, accepting that evidence disproved the criminal hypothesis.
...
El Destape documented 56 rulings where Rosenkrantz participated in cases involving his former clients, including 4 specifically concerning Grupo Clarin.

- **Former clients include:** Clarin, La Nacion, McDonald's, Quilmes, Grupo De Narvaez, Pegasus fund.
- **Timeline:** Rosenkrantz informed colleagues on 2021-10-21 that he would begin participating in former-client cases.
- **Legal basis for recusal (Art. 17 CPCCN):** "having been the lawyer for one of the litigants" is explicit grounds for disqualification.
...
Judge Gustavo Hornos (Camara Federal de Casacion Penal) maintained at least 6 private meetings with Macri at Casa Rosada (2015-2018), plus 2 at Olivos.

- The 6 visits to Casa Rosada occurred "days before dictating favorable sentences" aligned with Macri's political interests.
- The Consejo de la Magistratura opened an investigation.
- Each visit was followed by a ruling against Kirchnerism.
...
Judge Mariano Borinsky (Camara de Casacion) visited Macri at Olivos at least 15 times according to official visit records.
...
Multiple web searches for "Alberto Seijas" and "Maria Laura Seijas" yielded no public corroboration of the ARS 1,750,832,137.66 figure.

**Internal discrepancy found:** Our own codebase uses two different first names:
- `investigation-data.ts` says "Alberto Seijas" (asesor ad honorem, Consejo de la Magistratura)
- `resumen/page.tsx` says "Maria Laura Seijas"

These cannot both be correct. The DDJJ figure likely comes from the Oficina Anticorrupcion's public DDJJ dataset, which is downloadable but not easily web-searchable. No news article or NGO report was found referencing this specific claim.

**Action needed:** (1) Resolve the Alberto vs. Maria Laura discrepancy in the codebase, (2) link directly to the OA dataset row as primary source.
...
The 2% conviction rate is confirmed by an audit of the Consejo de la Magistratura:

- **Scope:** 730 files reaching 6 federal oral courts in Buenos Aires, 1996-2016.
- **Result:** Only 2 out of 100 officials investigated were convicted.
- **Additional data:** Of those reaching trial, 32% guilty, 34% acquitted. Average delay: 3.5 years; 20% of cases took 6+ years.
- **Source attribution:** The audit was promoted by the Colegio de Abogados de la Ciudad de Buenos Aires and other NGOs, carried out by the Consejo at the request of its president Miguel Piedecasas.
...
Current composition (20 members):
- 8 national legislators (4 senators + 4 deputies) = **40%**
- 4 judges
- 4 lawyers
- 1 representative of the Executive
- 2 academics
...
- Santiago Caputo's father: **Claudio Caputo Pena**, notary public (escribano).
- Claudio was president of the Colegio de Escribanos de Buenos Aires (2017-2019).
- Claudio died in 2023.
- Claudio married Maria Spinetto Bory; children: Santiago, Francisco, Ezequiel, Malena.
- Claudio created the Axis company, which administered Luis "Toto" Caputo's investment funds.
...
Family tree confirmed:

- **Patriarch:** Nicolas Caputo Lauria (born 1890 in Potenza, Italy). Founded "Nicolas Caputo S.A. de Edificacion" in 1938. Married Francisca Oliveto.
- **Three sons:** Luis Nicolas, Jorge Octavio, Rodolfo Julio.
- **Luis Nicolas** -> father of **Luis Andres "Toto" Caputo** (born 1965, current Economy Minister).
- **Jorge Octavio** -> father of **Nicolas "Nicky" Caputo** (businessman, close friend of Macri).
...
| # | Claim | Status | Notes |
|---|-------|--------|-------|
| 1 | Lijo Decreto 137/2025 | VERIFIED | Decree number, date, signatories confirmed |
| 2 | Lijo 89 cases, 14 to trial | VERIFIED | ACIJ data; 15% trial rate confirmed |
| 3 | Lijo apt Alvear/Bettini ~USD 2M | VERIFIED | LA NACION investigation confirmed |
| 4 | Ercolini Lago Escondido flight | VERIFIED | Judges, Clarin reps, Lewis estate confirmed |
| 5 | Ercolini-Frigerio Koolhaas clearance | VERIFIED | Dismissal after Lago Escondido confirmed |
| 6 | Ercolini-Techint "state of necessity" | VERIFIED | USD 1M bribes excused; UIF appealed |
| 7 | Rosenkrantz 56 rulings ex-clients | VERIFIED | El Destape count; 4 Clarin-related |
| 8 | Hornos 6+ meetings Casa Rosada | VERIFIED | 6 at Casa Rosada + 2 at Olivos |
| 9 | Borinsky 15+ visits Olivos padel | VERIFIED | Official records; Borinsky disputed count |
| 10 | Seijas ARS 1.75B | UNVERIFIABLE | No public corroboration; name discrepancy in codebase |
| 11 | 2% conviction rate | VERIFIED | Consejo Magistratura audit 1996-2016 |
| 12 | 40% legislators on Consejo | VERIFIED | 8 of 20 members = 40% |
| 13 | Santiago Caputo family tree | VERIFIED | Father Claudio escribano confirmed |
| 14 | Toto & Nicky Caputo = cousins | VERIFIED | First cousins via Nicolas Caputo Lauria |
| 15 | Catalan YPF $140M/month | VERIFIED | November 2025, multiple sources |

**Result: 14 VERIFIED, 0 CORRECTED, 1 UNVERIFIABLE**

### Action Items

1. **Seijas name discrepancy:** `investigation-data.ts` says "Alberto Seijas"; `resumen/page.tsx` says "Maria Laura Seijas". Must be reconciled against the actual OA DDJJ dataset row.
2. **2% conviction source attribution:** Slightly imprecise. Should specify "Cuerpo de Auditores del Consejo de la Magistratura, audit promoted by Colegio de Abogados de CABA (2018, covering 1996-2016)."
