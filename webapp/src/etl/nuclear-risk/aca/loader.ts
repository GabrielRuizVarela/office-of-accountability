/**
 * Load Arms Control Association signals into Neo4j.
...
export interface LoadAcaResult {
  readonly nodesCreated: number
  readonly batches: number
}

export async function loadAcaSignals(signals: readonly AcaSignalParams[]): Promise<LoadAcaResult> {
