...
export interface LoadIaeaResult {
  readonly nodesCreated: number
  readonly batches: number
}

export async function loadIaeaSignals(signals: readonly IaeaSignalParams[]): Promise<LoadIaeaResult> {
