/**
 * Load State Department signals into Neo4j.
...
export interface LoadStateDeptResult {
  readonly nodesCreated: number
  readonly batches: number
}

export async function loadStateDeptSignals(signals: readonly StateDeptSignalParams[]): Promise<LoadStateDeptResult> {
