/**
 * Load Bulletin of the Atomic Scientists signals into Neo4j.
...
export interface LoadBulletinResult {
  readonly nodesCreated: number
  readonly batches: number
}

export async function loadBulletinSignals(signals: readonly BulletinSignalParams[]): Promise<LoadBulletinResult> {
