/**
 * Load US DoD signals into Neo4j.
...
export interface LoadUsDodResult {
  readonly nodesCreated: number
  readonly batches: number
}

export async function loadUsDodSignals(signals: readonly UsDodSignalParams[]): Promise<LoadUsDodResult> {
