...
const CHAPTERS: {
  ...
  },
  {
    ...
    content: {
      es: [
        { text: 'Contratos de obra publica: CONTRAT.AR, MapaInversiones, Odebrecht, Cuadernos. ' },
        { text: '87,725', bold: true },
        { text: ' contratos, ' },
        { text: '30,829', bold: true },
        { text: ' contratistas, ' },
        { text: '7,486', bold: true },
        { text: ' obras. En paralelo, el estado de monopolizacion de ' },
        { text: '18 sectores', bold: true },
        { text: ' de la economia argentina. En marzo de 2026, una licitacion de ' },
        { text: '$3,650M', bold: true },
        { text: ' adjudicada por el Jefe de Gabinete Manuel Adorni a ATX S.A. Cruce por CUIT: ATX, Datco, Foggia, Movilgate y Lugalu ya estaban en la base de contratistas. ' },
        { text: '102', bold: true },
        { text: ' entidades, ' },
        { text: '6', bold: true },
        { text: ' causas judiciales, ' },
        { text: '11', bold: true },
      ...
      en: [
        ...
        { text: ' contractors, ' },
        { text: '7,486', bold: true },
        { text: ' works. In parallel, the monopolization status of ' },
        { text: '18 sectors', bold: true },
        { text: ' of the Argentine economy. In March 2026, a ' },
        { text: '$3,650M', bold: true },
        { text: ' tender awarded by Chief of Cabinet Manuel Adorni to ATX S.A. Cross-referencing by CUIT: ATX, Datco, Foggia, Movilgate, and Lugalu were already in the contractor database. ' },
        { text: '102', bold: true },
        { text: ' entities, ' },
        { text: '6', bold: true },
        { text: ' judicial cases, ' },
        { text: '11', bold: true },
        { text: ' cross-references with prior investigations.' },
      ],
    },
  },
  {
