...
const CHAPTERS: {
...
}[] = [
  {
    ...
    citations: [
      { id: 1, text: 'CONADEP — Informe Nunca Mas, Capitulo II: Centros clandestinos de detencion', url: 'https://desaparecidos.org/nuncamas/web/english/library/nevagain/nevagain_001.htm' },
      { id: 2, text: 'RUVTE — Registro Unificado de Victimas del Terrorismo de Estado', url: 'https://datos.jus.gob.ar/dataset/registro-unificado-de-victimas-del-terrorismo-de-estado-ruvte' },
      { id: 3, text: 'Plan Condor — Base de datos de victimas transfronterizas', url: 'https://plancondor.org' },
    ],
  },
  {
    num: 'II',
    ...
    paragraphs_en: [
      'The RUVTE (Unified Registry of Victims of State Terrorism) documents 9,415 victims with individual records — 8,632 with formal complaints and 783 from CONADEP listings without formal complaint.[4] The median age at the time of disappearance was 26 years. 334 pregnant women were detained or disappeared. 193 minors under 18 were documented, including the students of the Noche de los Lápices.',
      '589 foreign nationals from 32 countries appear in the registry — not only Uruguayans, Chileans, and Paraguayans (expected from Plan Cóndor), but victims from Japan, Greece, Russia, Lithuania, Belgium, Hungary, Finland, and beyond.[5] The international dimension is broader than commonly documented.',
      ...
      'Of the approximately 500 children born in captivity, Abuelas de Plaza de Mayo have restored the identity of approximately 140.[6] The graph includes 135 niños apropiados with restitution data.',
    ],
    paragraphs_es: [
      'El RUVTE (Registro Unificado de Victimas del Terrorismo de Estado) documenta 9.415 victimas con registros individuales — 8.632 con denuncia formal y 783 de listados de la CONADEP sin denuncia formal.[4] La edad mediana al momento de la desaparicion era de 26 anos. 334 mujeres embarazadas fueron detenidas o desaparecidas. 193 menores de 18 anos fueron documentados, incluyendo a los estudiantes de la Noche de los Lapices.',
      '589 nacionales extranjeros de 32 paises aparecen en el registro — no solo uruguayos, chilenos y paraguayos (esperables por el Plan Condor), sino victimas de Japon, Grecia, Rusia, Lituania, Belgica, Hungria, Finlandia y mas.[5] La dimension internacional es mas amplia de lo comunmente documentado.',
      ...
      'De los aproximadamente 500 ninos nacidos en cautiverio, Abuelas de Plaza de Mayo han restituido la identidad de aproximadamente 140.[6] El grafo incluye 135 ninos apropiados con datos de restitucion.',
    ],
    citations: [
      { id: 4, text: 'RUVTE — datos.jus.gob.ar, dataset completo de victimas', url: 'https://datos.jus.gob.ar/dataset/registro-unificado-de-victimas-del-terrorismo-de-estado-ruvte' },
      { id: 5, text: 'Wikidata SPARQL — victimas extranjeras de la dictadura argentina', url: 'https://query.wikidata.org/' },
      { id: 6, text: 'Abuelas de Plaza de Mayo — nietos restituidos', url: 'https://www.abuelas.org.ar/caso/buscar' },
    ],
  },
  {
    num: 'III',
    ...
    paragraphs_en: [
      'The graph maps 774 clandestine detention centers with GPS coordinates from the presentes dataset.[7] 747 have confirmed lat/lon coordinates — enough to build a complete national map. 19 have been converted to memory sites (espacios de memoria).',
      'Cross-referencing RUVTE victim detention locations against CCD names produced 2,528 DETENIDO_EN relationships — placing documented victims in specific detention centers.[8] The largest site by this measure is not ESMA but Comisaría 26ª de Capital Federal with 1,884 linked victims, followed by Automotores Orletti (71), and a network of Buenos Aires province comisarías each processing 20-50 victims.',
    ...
    paragraphs_es: [
      'El grafo mapea 774 centros clandestinos de detencion con coordenadas GPS del dataset presentes.[7] 747 tienen coordenadas lat/lon confirmadas — suficientes para construir un mapa nacional completo. 19 han sido convertidos en espacios de memoria.',
      'El cruce de datos entre las ubicaciones de detencion de victimas del RUVTE y los nombres de CCD produjo 2.528 relaciones DETENIDO_EN — ubicando victimas documentadas en centros de detencion especificos.[8] El sitio mas grande por esta medida no es la ESMA sino la Comisaria 26a de Capital Federal con 1.884 victimas vinculadas, seguido por Automotores Orletti (71), y una red de comisarias de la provincia de Buenos Aires procesando cada una entre 20 y 50 victimas.',
    ...
    citations: [
      { id: 7, text: 'presentes — paquete R con 762 CCD geolocalizados, DiegoKoz/presentes', url: 'https://github.com/DiegoKoz/presentes' },
      { id: 8, text: 'RUVTE cruce victima-CCD — datos.jus.gob.ar', url: 'https://datos.jus.gob.ar/dataset/registro-unificado-de-victimas-del-terrorismo-de-estado-ruvte' },
    ],
  },
  {
    num: 'IV',
    ...
    paragraphs_en: [
      'The graph tracks 10 major causas (judicial proceedings), 16 federal tribunals, and 12 sentencias (verdicts).[9] The judicial timeline spans four decades: the Trial of the Juntas (1985), the impunity laws (1986-1987), the Menem pardons (1989-1990), the constitutional annulment (2005), and the reopened megacausas (2006-present).',
      'Of 130 represors in the graph, only 24 (18.5%) have any judicial link — either ACUSADO_EN or CONDENADO_A. Only 12 have documented convictions.[10] The conviction rate for identified SIDE agents is 0% — the intelligence service achieved near-total institutional impunity.',
    ...
    paragraphs_es: [
      'El grafo rastrea 10 causas judiciales principales, 16 tribunales federales y 12 sentencias.[9] La linea temporal judicial abarca cuatro decadas: el Juicio a las Juntas (1985), las leyes de impunidad (1986-1987), los indultos de Menem (1989-1990), la anulacion constitucional (2005) y las megacausas reabiertas (2006-presente).',
      'De los 130 represores en el grafo, solo 24 (18,5%) tienen algun vinculo judicial — ya sea ACUSADO_EN o CONDENADO_A. Solo 12 tienen condenas documentadas.[10] La tasa de condena para los agentes de la SIDE identificados es del 0% — el servicio de inteligencia logro una impunidad institucional casi total.',
    ...
    citations: [
      { id: 9, text: 'PCCH — Dossier de Sentencias, Procuraduria de Crimenes contra la Humanidad', url: 'https://www.fiscales.gob.ar/lesa-humanidad/' },
      { id: 10, text: 'CONADEP — Nunca Mas, Capitulo IV: Represores', url: 'https://desaparecidos.org/nuncamas/web/english/library/nevagain/nevagain_001.htm' },
    ],
  },
  {
    num: 'V',
    ...
    citations: [
      { id: 11, text: 'Plan Condor — base de datos de victimas transfronterizas', url: 'https://plancondor.org' },
      { id: 12, text: 'desclasificados.org.ar — documentos de inteligencia de EE.UU. desclasificados', url: 'https://desclasificados.org.ar' },
    ],
  },
  {
    num: 'VI',
    ...
    citations: [
      { id: 13, text: 'CONADEP — Nunca Mas, Capitulo V: Complicidad empresarial', url: 'https://desaparecidos.org/nuncamas/web/english/library/nevagain/nevagain_001.htm' },
      { id: 14, text: 'PCCH — sentencia Ford Motor Argentina (2018), causa no. 4012/2006', url: 'https://www.fiscales.gob.ar/lesa-humanidad/' },
    ],
  },
  {
    num: 'VII',
    ...
    paragraphs_en: [
      'On March 24, 2026 — the 50th anniversary of the coup — the Argentine government declassified 987 pages of internal SIDE documents spanning 1973-1983.[15] This investigation ingested the entire corpus through a pre-processed knowledge graph containing 3,752 entities and 4,056 relationships.',
      'The documents reveal the SIDE\'s complete organizational structure: Subsecretaría A (Interior Intelligence), Subsecretaría B (Foreign Intelligence), Subsecretaría C (Logistics/Support), and the CNI (Central Nacional de Inteligencia). 881 departments are mapped.[16] The declassified documents also reveal the SIDE\'s ideological classification system, its surveillance of human rights organizations, and its secret psychological operations directives.',
    ...
    paragraphs_es: [
      'El 24 de marzo de 2026 — 50 aniversario del golpe — el gobierno argentino desclasificó 987 paginas de documentos internos de la SIDE del periodo 1973-1983.[15] Esta investigacion ingirio el corpus completo a traves de un grafo de conocimiento preprocesado conteniendo 3.752 entidades y 4.056 relaciones.',
      'Los documentos revelan la estructura organizativa completa de la SIDE: Subsecretaria A (Inteligencia Interior), Subsecretaria B (Inteligencia Exterior), Subsecretaria C (Apoyo Logistico) y la CNI (Central Nacional de Inteligencia). 881 departamentos estan mapeados.[16] Los documentos desclasificados tambien revelan el sistema de clasificacion ideologica de la SIDE, su vigilancia de organizaciones de derechos humanos y sus directivas secretas de operaciones psicologicas.',
    ...
    citations: [
      { id: 15, text: 'ManuelR-D/datos-desclasificados-prn — 987 paginas de documentos SIDE desclasificados', url: 'https://github.com/ManuelR-D/datos-desclasificados-prn' },
      { id: 16, text: 'Wikidata SPARQL — estructura organizativa SIDE, cruce de agentes', url: 'https://query.wikidata.org/' },
    ],
  },
  {
    num: 'VIII',
    ...
    paragraphs_en: [
      'This investigation flags 54 accountability gaps in the Neo4j graph: 27 high-victim CCDs with no judicial proceedings, 16 SIDE officials with zero judicial links, 8 represors with documented evidence but no prosecution, and 6 Junta III/IV members with a command responsibility gap.[17]',
      'The single largest accountability void is Comisaría 26ª de Capital Federal: 1,884 documented victims, zero identified perpetrators, zero judicial link.[18] This police station processed more victims than any other site in the graph — more than ESMA, Campo de Mayo, and Automotores Orletti combined. Yet no commander, no officer, no guard has been named.',
    ...
    citations: [
      { id: 17, text: 'PCCH — estado de causas por delitos de lesa humanidad', url: 'https://www.fiscales.gob.ar/lesa-humanidad/' },
      { id: 18, text: 'RUVTE — victimas por lugar de detencion, cruce con CCD', url: 'https://datos.jus.gob.ar/dataset/registro-unificado-de-victimas-del-terrorismo-de-estado-ruvte' },
    ],
  },
  {
    num: 'IX',
    ...
    citations: [
      { id: 19, text: 'RUVTE — datos.jus.gob.ar, dataset abierto', url: 'https://datos.jus.gob.ar/dataset/registro-unificado-de-victimas-del-terrorismo-de-estado-ruvte' },
      { id: 20, text: 'desclasificados.org.ar — 3.200+ documentos de inteligencia desclasificados', url: 'https://desclasificados.org.ar' },
    ],
  },
]
        ...
        >
          ...
          {(lang === 'es' ? ch.paragraphs_es : ch.paragraphs_en).map((p, i) => (
            <p key={i} className="mx-auto max-w-3xl text-left leading-relaxed text-zinc-400">
              {renderWithCitations(p, ch.citations)}
            </p>
          ))}

          {/* Chapter citation footnotes */}
          {ch.citations && ch.citations.length > 0 && (
            <div className="mx-auto mt-4 max-w-3xl rounded border border-zinc-800/50 bg-zinc-900/30 px-4 py-3">
        ...
        <div className="mt-6 space-y-6">
          <div className="rounded-lg border border-zinc-800 bg-zinc-900/40 p-5">
            ...
            <div className="mt-3 space-y-3 text-sm text-zinc-300">
              <p>{lang === 'es'
                ? 'Esta investigación fue construida mediante inteligencia artificial asistida con verificación humana. Múltiples pipelines de ingesta consolidaron datos de 12 fuentes públicas en un grafo Neo4j de 14,512 nodos. Resolución de entidades por nombre, fecha y ubicación cruzó víctimas, centros clandestinos, perpetradores y documentos desclasificados.'
                : 'This investigation was built through AI-assisted intelligence with human verification. Multiple ingestion pipelines consolidated data from 12 public sources into a Neo4j graph of 14,512 nodes. Entity resolution by name, date, and location cross-referenced victims, clandestine centers, perpetrators, and declassified documents.'}</p>
              <p>{lang === 'es'
          ...
          <div className="rounded-lg border border-zinc-800 bg-zinc-900/40 p-5">
            ...
            <ul className="mt-3 space-y-2 text-sm text-zinc-300">
              <li>{lang === 'es'
                ? 'Tres niveles de confianza: gold (164 nodos curados), silver (10,564 verificados web), bronze (3,550 sin verificar)'
                : 'Three confidence tiers: gold (164 curated nodes), silver (10,564 web-verified), bronze (3,550 unverified)'}</li>
              <li>{lang === 'es'
                ? '88.4% de nodos verificados contra fuentes primarias'
                : '88.4% of nodes verified against primary sources'}</li>
              <li>{lang === 'es'
                ? 'Resolución de entidades fusionó 86 duplicados'
                : 'Entity resolution merged 86 duplicates'}</li>
              <li>{lang === 'es'
                ? 'Análisis LLM + verificación web para cada hallazgo'
                : 'LLM analysis + web verification for every finding'}</li>
            </ul>
          </div>
          ...
          <div className="rounded-lg border border-zinc-800 bg-zinc-900/40 p-5">
            ...
            <div className="mt-3 grid grid-cols-2 gap-2 text-xs text-zinc-400">
              <span>RUVTE (víctimas)</span>
              <span>presentes (CCDs)</span>
              <span>SNEEP (penas)</span>
              <span>desclasificados.org.ar</span>
              <span>Plan Cóndor</span>
              <span>Abuelas de Plaza de Mayo</span>
              <span>Actas Junta Militar</span>
              <span>Nunca Más</span>
              <span>PCCH sentencias</span>
              <span>Wikidata SPARQL</span>
              <span>SIDE documents (987 pp)</span>
              <span>CONADEP</span>
            </div>
          </div>
        </div>
