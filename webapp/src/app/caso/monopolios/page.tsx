...
const t = {
  ...
  executiveSummary: {
    en: 'This investigation traced monopoly power across 18 Argentine market sectors through a 32-wave research cycle. Cross-referencing the Neo4j knowledge graph (2.45M nodes, 4.69M relationships) with web research, ICIJ offshore leaks, IGJ corporate registry, CompraR procurement, CNE campaign finance, and the obras-publicas investigation (37K nodes) produced 829+ unique findings. 75 claims were factchecked: 55% verified, 29% corrected, 1% debunked. The annual consumer cost of monopolization is estimated at USD 22.5B (3.3% of GDP), with the poorest quintile losing 15% of income to monopoly pricing.',
    es: 'Esta investigacion trazo el poder monopólico en 18 sectores del mercado argentino a traves de un ciclo de investigacion de 32 ondas. El cruce del grafo de conocimiento Neo4j (2,45M nodos, 4,69M relaciones) con investigacion web, filtraciones offshore ICIJ, registro corporativo IGJ, CompraR, finanzas de campana CNE y la investigacion de obras publicas (37K nodos) produjo 829+ hallazgos unicos. 75 afirmaciones fueron verificadas: 55% confirmadas, 29% corregidas, 1% desmentida. El costo anual al consumidor por monopolizacion se estima en USD 22.500M (3,3% del PIB), con el quintil mas pobre perdiendo 15% de sus ingresos por precios monopólicos.',
  },
