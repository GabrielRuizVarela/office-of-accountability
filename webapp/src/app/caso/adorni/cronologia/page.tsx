...
import { TIMELINE_EVENTS } from '@/lib/caso-adorni/investigation-data'

const t = {
  title: { en: 'Chronology', es: 'Cronologia' },
  subtitle: {
    en: 'Timeline from Adorni\'s appointment as presidential spokesperson through official advertising contracts, statement controversies, and corruption allegations.',
    es: 'Linea de tiempo desde la designacion de Adorni como vocero presidencial, pasando por los contratos de pauta oficial, las controversias por declaraciones, y las denuncias de corrupcion.',
  },
