...
const chapters: readonly Chapter[] = [
  ...
  },
  {
    ...
    paragraphs: {
      es: [
        ...
        'Esta investigacion identifico 4 personas que aparecen tanto en el caso Adorni como en la investigacion LIBRA: Karina Milei, Santiago Caputo, Julian Peh y Mauricio Novelli.',
      ],
      en: [
        ...
        'This investigation identified 4 persons who appear in both the Adorni case and the LIBRA investigation: Karina Milei, Santiago Caputo, Julian Peh, and Mauricio Novelli.',
      ],
    },
    citations: [
  ...
  },
  {
    ...
    paragraphs: {
      es: [
        'Al cierre de esta investigacion, la base de datos contiene 102 entidades y 133 relaciones entre ellas. 37 personas, 38 organizaciones, 17 declaraciones disputadas, 5 flujos de dinero y 6 causas judiciales (CFP 1003/2026 ante Lijo, causa Rafecas por avion presidencial, investigacion Lijo por vuelo privado, denuncia ATX/Tecnopolis, ANDIS CFP 3402/2025, y LIBRA CFP 574/2025 con FBI/DOJ). 11 entidades de este caso aparecen tambien en otras investigaciones de esta plataforma: en la investigacion LIBRA (Karina Milei, Santiago Caputo, Julian Peh, Mauricio Novelli) y en la base de contratistas de obras publicas (ATX, Datco, Foggia, Movilgate, Lugalu).',
      ...
      en: [
        'At the close of this investigation, the database contains 102 entities and 133 relationships between them. 37 persons, 38 organizations, 17 disputed statements, 5 money flows, and 6 legal cases (CFP 1003/2026 before Lijo, Rafecas presidential aircraft case, Lijo private flight investigation, ATX/Tecnopolis complaint, ANDIS CFP 3402/2025, and LIBRA CFP 574/2025 with FBI/DOJ). 11 entities from this case also appear in other investigations on this platform: in the LIBRA investigation (Karina Milei, Santiago Caputo, Julian Peh, Mauricio Novelli) and in the public works contractor database (ATX, Datco, Foggia, Movilgate, Lugalu).',
