...
import { MONEY_FLOWS } from '@/lib/caso-adorni/investigation-data'

const t = {
  title: { en: 'The Money', es: 'El Dinero' },
  subtitle: {
    en: 'Tracking official advertising spend (pauta oficial), media contracts, asset declarations, and financial flows connected to the presidential spokesperson\'s office.',
    es: 'Rastreo de pauta oficial, contratos mediaticos, declaraciones juradas patrimoniales, y flujos financieros conectados a la voceria presidencial.',
  },
  totalTracked: { en: 'Total tracked (ARS)', es: 'Total rastreado (ARS)' },
  totalNote: {
    en: 'Includes official advertising, contracts, and documented flows',
    es: 'Incluye pauta oficial, contratos y flujos documentados',
  },
