...
const t = {
  ...
  connectionsDesc: {
    en: 'Interactive graph: 227 investigation nodes, 341 relationships. Filter by Revolving Door, Offshore, Money Trail, Power Families.',
    es: 'Grafo interactivo: 227 nodos de investigacion, 341 relaciones. Filtre por Puerta Giratoria, Offshore, Rastro del Dinero, Familias del Poder.',
  },
