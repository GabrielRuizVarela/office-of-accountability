...
const chapters: readonly Chapter[] = [
  ...
  },
  {
    ...
    paragraphs: {
      ...
      en: [
        ...
        'But the Ley de Bases vote did not emerge in an ideological vacuum. Behind Milei there is a transnational influence infrastructure. According to The Intercept [63], the Koch/Atlas Network pipeline channeled at least USD 12 million toward public policy organizations in Latin America, feeding 12 Argentine think tanks that produced the intellectual framework for deregulation. According to Chequeado [64], Fundacion Faro — identified as the main libertarian financing vehicle — spent $1.079 billion on electoral advertising in 2025 without declaring the origin of its funds. According to CNE records, 70% of Milei\'s campaign financing came from three companies with no known public profile.',
  ...
  },
  {
    ...
    pullQuote: {
      es: 'Segun los Paradise Papers, Noctua — vinculada a Caputo — habria comprado el Century Bond que Caputo autorizo como funcionario. De confirmarse, emisor y comprador serian la misma persona.',
      en: 'According to the Paradise Papers, Noctua — linked to Caputo — allegedly bought the Century Bond that Caputo authorized as an official. If confirmed, the issuer and the buyer would be the same person.',
    },
    citations: [
  ...
  },
  {
    ...
    paragraphs: {
      ...
      en: [
        ...
        'The Milei cabinet presents a notable concentration from a single investment bank: seven officials with JP Morgan backgrounds — Caputo, Bausili, Daza, Werning, Quirno, Lew, and Reidel — according to public appointment records from the Boletin Oficial and verified professional profiles.[22] This concentration raises questions about potential conflicts of interest when the same team negotiates sovereign debt with their former colleagues on the other side of the table.',
  ...
  },
  {
    ...
    paragraphs: {
      ...
      en: [
        'Asset declarations of public officials, cross-referenced with their official salaries and AFIP records, reveal anomalies that mathematics cannot explain. But data cross-referencing also produces traps: namesakes, denomination changes, format errors. The rigor of an investigation is measured as much by what it discards as by what it confirms.',
  ...
  },
  {
    ...
    paragraphs: {
      ...
      en: [
        ...
        'The analysis engine — running locally, no external data transmission — processed every pattern and confirmed matches against primary sources. Every finding was verified before inclusion. The graph does not accuse. It reveals patterns.',
      ],
    },
    pullQuote: {
      es: '294 nodos. 2.391 aristas. 87 factchecks. $483.000M offshore. El grafo no acusa. Revela patrones.',
      en: '294 nodes. 2,391 edges. 87 factchecks. $483B offshore. The graph does not accuse. It reveals patterns.',
    },
    citations: [
  ...
  },
  {
    id: 'el-cruce',
    title: {
      es: 'XVII. El Cruce: 34.776 Identidades Reveladas',
      en: 'XVII. The Cross-Match: 34,776 Identities Revealed',
    },
    paragraphs: {
      es: [
      ...
      en: [
        'Argentina\'s CUIT — Unique Tax ID Code — has 11 digits. The first two indicate whether it\'s a person (20, 23, 24, 27) or company (30, 33, 34). The middle eight are the DNI (national ID). The last is a check digit. This simple structure enables something no other country makes this easy: cross-matching identities across databases that were never designed to talk to each other.',
        'The entity resolution engine cross-matched 317,656 records with CUIT from four sources: the state contractor registry (Compr.ar/Boletin Oficial), the company registry (IGJ), campaign donors (CNE), and sworn asset declarations (DDJJ). It extracted the DNI from each CUIT and compared it against 840,083 records of corporate officers and government appointees. Result: 34,776 matches.',
        'The most severe findings: Juan Javier Negri, PEN Board Member at the Education Ministry, appears as officer of 115 companies — including LLCs incorporated in Delaware (Regency-Wyndclyff, Cristal Delaware). Pablo Clusellas, Secretary to the Presidency, in 51 companies — including SACDE, the mega-constructor of the Calcaterra/Macri group. Horacio Reyser, Secretary of Foreign Affairs, in 26 Estrella Group companies — and also appears as a campaign donor. Triple role: official, businessman, political financier.',
        'Three operational networks were detected. The energy and telecom network (Reyser-Malvido axis): cross-interests in petroleum holdings, transport companies, and telecom. The security network (Martinez-Prusak axis): SECAR Security fragmented into three corporate variants (Group, Countries, Servicios), linked to Cabinet and Defense officials. The infrastructure network (Frigerio-Jahn axis): real estate developments and fiduciary firms linked to Interior Ministry officials who control the public works budget.',
        '146 companies registered in IGJ with zero officers receive state contracts. The most severe: AMOV IV, Variable Capital Corporation — a Mexican corporate structure that won 65 Argentine contracts with no registered officer. Trigemios S.R.L. won 246 contracts. Diego Alberto Moral, an individual, won 206. A cluster of cleaning companies — MAXXILIMP (156), El Cacique Limpieza (147) — accumulates disproportionate volumes for SRLs of that size.',
        '29,602 sworn asset declarations were linked to company officers and government appointees. This opens an investigative line that was previously impossible: comparing wealth declared by an official against the corporate positions they simultaneously hold. If a Secretary of State declares modest assets but directs 26 petroleum companies, the discrepancy speaks for itself.',
        'The De Grazia brothers — Joaquin (15 companies) and Marcelo (13 companies) — share Grupo Argentino de Alimentos, Electro GTA, Avicola del Plata, and a Reciprocal Guarantee Society. They are political donors. The family network spans food industry, energy, and finance. Gentile and Siciliano, both Chief Auditors at the Cabinet Office, share 14 state companies — Ferrocarriles Argentinos, ARSAT, AySA, Nacion Servicios — the same entities they should be auditing.',
        'Every match was verified against the original DNI before publication. Only cross-references where the document number matches across both sources are included. This methodology — documentary evidence over textual similarity — is what separates investigation from noise.',
      ],
    },
    pullQuote: {
      es: 'Si un Secretario de Estado declara un patrimonio modesto pero dirige 26 empresas petroleras, la discrepancia habla por si sola.',
      en: 'If a Secretary of State declares modest assets but directs 26 petroleum companies, the discrepancy speaks for itself.',
    },
    citations: [
      { id: 201, text: 'IGJ — Inspeccion General de Justicia, registro publico de sociedades', url: 'https://www.argentina.gob.ar/justicia/igj' },
      { id: 202, text: 'Compr.ar — Sistema de contrataciones publicas', url: 'https://comprar.gob.ar' },
      { id: 203, text: 'CNE — Camara Nacional Electoral, aportantes', url: 'https://aportantes.electoral.gob.ar' },
      { id: 204, text: 'DDJJ — Declaraciones juradas patrimoniales', url: 'https://datos.gob.ar' },
    ],
  },
]
...
const stats: readonly StatCard[] = [
  ...
  { value: '2,155', label: { es: 'Puerta giratoria documentada', en: 'Documented revolving door' } },
  { value: '34,776', label: { es: 'Cruces CUIT/DNI', en: 'CUIT/DNI cross-matches' } },
]
