...
const chapters: readonly Chapter[] = [
  ...
  },
  {
    ...
    paragraphs: {
      ...
      en: [
        'Luis Caputo worked at JP Morgan (1994-1998) and Deutsche Bank (1998-2008). As Milei\'s Economy Minister, he designated JP Morgan as fiduciary agent for sovereign bond repurchase using World Bank funds.[43] His consulting firm Anker Latinoamerica (CUIT 30-71690088-2) suspended operations on November 30, 2023, days before he took office. Anker partners Furiase, Vauthier, and Beron moved directly into the Economy Ministry.',
        'The pattern runs deeper than previously known: not six but seven Milei officials have JP Morgan backgrounds — Caputo, Bausili, Daza, Werning, Quirno, Lew, and Reidel.[44] Santiago Bausili, current BCRA president, received ~USD 200,000 in Deutsche Bank stock and bonuses while serving as Finance Secretary, directing state debt operations that benefited his former employer. He is processed for negotiations incompatible with public office.',
        'But the most explosive piece of the Caputo dossier came from the Paradise Papers. The investigation revealed a four-tier offshore chain that Caputo never declared when entering government in 2015: he owned 75% of Princess International Global Ltd (Cayman Islands), which controlled 50-74% of Affinis Partners II (Cayman), which in turn controlled Noctua International (Miami/Delaware), manager of Alto Global Fund — a Cayman fund with over USD 100 million in assets under management and a USD 1 million entry minimum.[47][48] When asked, Caputo presented himself as "merely an administrator." The documents show he was the actual owner. He separated from Noctua on November 25, 2015 — days before assuming the Finance Secretary role — but none of these entities appeared in his mandatory financial disclosure.',
        'Once in office, Caputo committed what UFISES considered a criminal conflict of interest. In March 2012 he had founded AXIS SGFCI S.A. (CUIT 30-71224145-0), holding 60% ownership. As Finance Secretary in 2015, he sat on the Executive Committee of the Fondo de Garantia de Sustentabilidad (FGS-ANSES), which approved AR$500 million in pension fund investment into AXIS Ahorro Plus FCI — his own mutual fund.[49] Commissions were split: AR$1.4M for AXIS and AR$500K for Deutsche Bank, his former employer. The criminal complaint was filed by UFISES and assigned to Judge Luis Rodriguez with Prosecutor Eduardo Taiano.[50]',
        'Hidden debt is another dimension. The AGN verified that Resolution 147/2017 — bearing Caputo\'s signature — created USD 7.368 billion in indirect debt through National Treasury Notes guaranteeing the renewable energy program. That debt was kept out of official statistics.[53] In 2017 he also issued the 100-year bond (USD 2.75B) that the AGN qualified as "little transparent and inefficient, compromising future generations." Argentina would repay over 900% of the net received over the bond\'s life. In January 2024, he took USD 3.2 billion from BCRA reserves via DNU 23/2024, leaving a non-transferable 10-year letter — practically valueless.[45]',
        'Caputo\'s net worth quintupled since he entered public office. His 2024 asset declaration reports AR$11.851 billion, with 99.9% of liquid assets held abroad.[51] He declares a field spanning 81 million square meters in Santiago del Estero, a yacht, and properties in four provinces. Part of that land is managed through Sacha Rupaska SA, where he holds 33.33%; his partner L.M. Mendez Ezcurra is married to Rossana Caputo, his sister. The land faces accusations of illegal logging.[54]',
        'And the Caputo orbit extends beyond finance. The family company Caputo Hermanos (CUIT 33-70897527-9, owned by Flavio and Hugo Caputo) hired Jonathan Morel, leader of Revolucion Federal, with invoices and wire transfers exceeding AR$8 million.[52] Morel was prosecuted in the investigation of the assassination attempt against Cristina Fernandez de Kirchner. The link between the Caputo clan and that investigation has never been publicly explained.',
    ...
    citations: [
      ...
      { id: 47, text: 'Noctua offshore — La Nacion', url: 'https://www.lanacion.com.ar/politica/luis-caputo-estuvo-vinculado-a-un-entramado-de-fondos-offshore-nid2079604/' },
      { id: 48, text: 'Paradise Papers Caputo — Buenos Aires Times', url: 'https://www.batimes.com.ar/news/argentina/caputo-concealed-cayman-island-offshore-firms-from-argentine-authorities.phtml' },
      { id: 49, text: 'AXIS fondo de inversion amigo — Pagina 12', url: 'https://www.pagina12.com.ar/61421-un-fondo-de-inversion-amigo' },
      { id: 50, text: 'UFISES denuncia Caputo — Fiscales.gob.ar', url: 'https://www.fiscales.gob.ar/fiscalias/la-ufises-denuncio-al-ministro-luis-caputo-por-presuntas-operaciones-irregulares-en-el-fondo-de-garantia-de-sustentabilidad/' },
      { id: 51, text: 'DDJJ Caputo 2024 — Chequeado', url: 'https://chequeado.com/el-explicador/la-declaracion-jurada-de-luis-caputo-informo-un-patrimonio-de-11-800-millones-y-casi-2-tercios-de-sus-bienes-estan-en-el-exterior/' },
      { id: 52, text: 'Caputo Hermanos contrato a Morel — Infobae', url: 'https://www.infobae.com/politica/2022/10/21/la-contratacion-de-caputo-hermanos-al-lider-de-revolucion-federal-facturas-y-transferencias-por-mas-de-8-millones-de-pesos/' },
      { id: 53, text: 'AGN bono del siglo — El Cronista', url: 'https://www.cronista.com/economia-politica/deuda-la-agn-cuestiono-la-colocacion-del-bono-del-siglo-en-el-gobierno-de-macri/' },
      { id: 54, text: 'Clan Caputo — Perfil', url: 'https://www.perfil.com/noticias/politica/quien-es-quien-en-el-clan-caputo-una-familia-siempre-vinculada-a-la-politica-y-el-poder.phtml' },
    ],
  },
  {
    id: 'lo-que-queda',
