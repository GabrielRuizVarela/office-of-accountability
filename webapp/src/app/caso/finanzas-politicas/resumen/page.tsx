...
const chapters: readonly Chapter[] = [
  {
    ...
    paragraphs: {
      ...
      en: [
        ...
        'This investigation cross-referenced nine data sources — legislative votes, offshore leaks, campaign donations, Boletin Oficial appointments, IGJ corporate registry, CNV board members, asset declarations, CAMMESA records, and public contracts — and built a graph of 290 nodes and 2,249 edges tracking 122 persons across 40 years of democracy. Sixty-five autonomous investigation agents processed the cross-references. Legislators who are corporate board members. Campaign donors who are government contractors. Officials who operate offshore entities while voting on budgets. 617 politicians appear in two or more datasets simultaneously. The network is not a hypothesis. It is a graph.',
      ],
    },
    pullQuote: {
  ...
  },
  {
    ...
    pullQuote: {
      es: '290 nodos. 2.249 aristas. 87 factchecks. $483.000M offshore. El grafo no acusa. Revela patrones.',
      en: '290 nodes. 2,249 edges. 87 factchecks. $483B offshore. The graph does not accuse. It reveals patterns.',
    },
    citations: [
