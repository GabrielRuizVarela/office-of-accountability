  ...
  },
  {
    ...
    paragraphs: {
      es: [
        ...
        'Lo que falta — y lo decimos porque la transparencia es la primera obligacion de quien investiga: los vinculos offshore-juez no estan resueltos (no sabemos si los jueces de Comodoro Py tienen sociedades offshore). La cadena donante-juez permanece opaca. Datos provinciales: solo CABA y Mendoza publican en estandar OCDS; las provincias mas opacas (Formosa 31 anios de Insfran, San Luis 35 anios de Rodriguez Saa, Salta con el 71% de pauta oficial al medio del senador) son las mas relevantes. Faltan 12 causas de corrupcion por documentar (AMIA/Nisman, Skanska, Rio Turbio, vacunatorio VIP). El periodo 1983-2007 tiene cobertura delgada. Sectores enteros — mineria/litio, sindicatos, transporte — no estan incluidos. La resolucion de entidades entre donantes y directivos corporativos funciona solo por nombre exacto; el cruce por CUIT requiere fulltext indexes aun no implementados. Y Nestor Kirchner, la pieza central de la era K, fue agregado pero necesita mas conexiones.',
        'Proximos pasos: integrar OpenSanctions (2,1 millones de entidades PEP/sanciones/Interpol, descarga gratuita). Construir wrapper para API de BCRA Central de Deudores (libre, sin autenticacion). Ingestar datos provinciales de CABA (OCDS, GitHub scripts disponibles) y Mendoza (OCP registrado). Rastrear el flujo cripto de $91.000 millones anuales con datos on-chain. Resolver los 5 codinombres de Odebrecht no identificados (Duvidoso, Festanca, Sindico, Bonito, Pato). Construir los 7 Money Trails como productos comerciales. Y la causa AMIA — 30 anios sin justicia, con el dossier de 40 eventos ya preparado — merece su propio capitulo en la proxima version.',
      ...
      en: [
        ...
        'What is missing — and we state this because transparency is the first obligation of those who investigate: offshore-judge links remain unresolved (we do not know if Comodoro Py judges hold offshore companies). The donor-judge chain remains opaque. Provincial data: only CABA and Mendoza publish in OCDS standard; the most opaque provinces (Formosa with 31 years of Insfran, San Luis with 35 years of Rodriguez Saa, Salta with 71% of state advertising going to the senator\'s own media) are the most relevant. 12 corruption cases remain undocumented (AMIA/Nisman, Skanska, Rio Turbio, VIP vaccination). The 1983-2007 period has thin coverage. Entire sectors — mining/lithium, unions, transport — are not included. Entity resolution between donors and corporate officers works only by exact name; CUIT-based matching requires fulltext indexes not yet implemented. And Nestor Kirchner, the central figure of the K era, was added but needs more connections.',
        'Next steps: integrate OpenSanctions (2.1 million PEP/sanctions/Interpol entities, free bulk download). Build the BCRA Central de Deudores API wrapper (free, no authentication required). Ingest provincial procurement from CABA (OCDS, GitHub scripts available) and Mendoza (OCP registered). Trace the $91 billion annual crypto flow with on-chain data. Resolve the 5 unidentified Odebrecht codenames (Duvidoso, Festanca, Sindico, Bonito, Pato). Build the 7 Money Trails as commercial products. And the AMIA case — 30 years without justice, with a 40-event dossier already prepared — deserves its own chapter in the next version.',
