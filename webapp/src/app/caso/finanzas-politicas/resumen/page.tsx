  ...
  },
  {
    ...
    paragraphs: {
      es: [
        ...
        'El algoritmo de matching por nombre (Levenshtein ≤ 2) produjo un falso positivo revelador: conecto a "TINELLI" con "PINELLI" — nombres similares, DNIs completamente distintos. Este control de calidad — verificar cada cruce contra el DNI original — es lo que separa la evidencia del ruido. Cada uno de los hallazgos publicados fue verificado contra el DNI crudo en Neo4j.',
      ],
      en: [
        ...
        'The name-matching algorithm (Levenshtein ≤ 2) produced a revealing false positive: it connected "TINELLI" with "PINELLI" — similar names, completely different DNIs. This quality control — verifying each match against the original DNI — is what separates evidence from noise. Every finding published here was verified against the raw DNI in Neo4j.',
      ],
    },
    pullQuote: {
