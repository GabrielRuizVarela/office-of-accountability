...
const t = {
  ...
  subtitle: {
    en: 'How a single financial relationship built a trafficking empire shielded by wealth, power, and institutional failure. 6,622 documented entities, 953K+ verified relationships, 39 events spanning 2005–2026. Built from court records, DOJ file releases, flight logs, and investigative reporting.',
    es: 'Como una sola relacion financiera construyo un imperio de trafico protegido por riqueza, poder y fracaso institucional. 6,622 entidades documentadas, 953K+ relaciones verificadas, 39 eventos entre 2005–2026. Basado en registros judiciales, archivos del DOJ, bitacoras de vuelo y periodismo de investigacion.',
  },
  readStory: {
  ...
  investigationDesc: {
    en: '20 factchecked claims, 293 web-verified persons, documents, and organizations, money flows, evidence chain, and government response',
    es: '20 afirmaciones verificadas, 293 personas, documentos y organizaciones verificadas en la web, flujos de dinero, cadena de evidencia y respuesta gubernamental',
  },
  networkGraph: {
    en: 'Network Graph',
    es: 'Grafo de Red',
