  ...
  },
  {
    ...
    content: {
      es: [
        ...
        '9. BCRA Central de Deudores — estado crediticio por CUIT',
        '10. Registro Nacional de Sociedades — CSV mensual, CUIT, razon social, tipo societario, domicilios',
        '11. OpenSanctions — entidades PEP, sanciones e Interpol',
      ...
      en: [
        ...
        '9. BCRA Central de Deudores — credit status by CUIT',
        '10. Registro Nacional de Sociedades — monthly CSV, CUIT, company name, type, addresses',
        '11. OpenSanctions — PEP, sanctions, and Interpol entities',
  ...
  },
  {
    ...
    content: {
      es: [
        ...
        'Proceso de control de calidad: cada coincidencia automatica es revisada manualmente. Las coincidencias por nombre comun sin evidencia independiente son descartadas. Los artefactos de datos (valores atipicos por cambios de denominacion o errores de formato) son identificados y corregidos.',
      ...
      en: [
        ...
        'Quality control process: every automated match is manually reviewed. Common-name matches without independent evidence are discarded. Data artifacts (outliers from denomination changes or format errors) are identified and corrected.',
