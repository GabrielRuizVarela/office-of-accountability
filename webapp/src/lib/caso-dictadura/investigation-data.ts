...
export const FACTCHECK_ITEMS: FactcheckItem[] = [
  ...
  },
  {
    ...
    claim_en: 'Causa Plan Cóndor is the most connected node with 9,354 relationships',
    claim_es: 'Causa Plan Cóndor es el nodo más conectado con 9.354 relaciones',
    status: 'under_investigation' as const,
    source: 'OA graph network analysis — LLM Wave 23',
    source_url: '',
    detail_en: '9,354 relationships link this judicial proceeding to victims, detention centers, intelligence documents, and represors across 6 countries.',
    detail_es: '9.354 relaciones vinculan este proceso judicial con víctimas, centros de detención, documentos de inteligencia y represores en 6 países.',
  },
  {
    id: 'fc-qwen-network-2',
    claim_en: 'Jorge Rafael Videla bridges 5 different entity types',
    claim_es: 'Jorge Rafael Videla conecta 5 tipos de entidades distintas',
    status: 'under_investigation' as const,
    source: 'OA graph network analysis — LLM Wave 23',
    source_url: '',
    detail_en: 'Videla links to 3 Juntas, 4 causas judiciales, 5 Cuerpos de Ejército, detention centers including ESMA and Campo de Mayo, and declassified US intelligence cables confirming State Department awareness.',
    detail_es: 'Videla se vincula con 3 Juntas, 4 causas judiciales, 5 Cuerpos de Ejército, centros de detención incluyendo ESMA y Campo de Mayo, y cables de inteligencia desclasificados de EE.UU. que confirman el conocimiento del Departamento de Estado.',
  },
  {
    id: 'fc-qwen-network-3',
    claim_en: 'Comisaría 26ª de Capital Federal emerges as the largest detention cluster',
    claim_es: 'Comisaría 26ª de Capital Federal emerge como el mayor cluster de detención',
    status: 'under_investigation' as const,
    source: 'OA graph network analysis — LLM Wave 23',
    source_url: '',
    detail_en: '1,884 documented victims. Zero connected represors. Zero judicial proceedings.',
    detail_es: '1.884 víctimas documentadas. Cero represores conectados. Cero causas judiciales.',
  },
  {
    id: 'fc-qwen-network-4',
    claim_en: '1 CCD shows documented represor-victim connections',
    claim_es: '1 CCD muestra conexiones documentadas represor-víctima',
    status: 'under_investigation' as const,
    source: 'OA graph network analysis — LLM Wave 23',
    source_url: '',
    detail_en: 'This detention center has both victims and identified represors linked in the graph.',
    detail_es: 'Este centro de detención tiene tanto víctimas como represores identificados vinculados en el grafo.',
  },
  {
    id: 'fc-qwen-network-5',
    claim_en: '58 highly-connected nodes remain at bronze tier',
    claim_es: '58 nodos altamente conectados permanecen en nivel bronce',
    status: 'under_investigation' as const,
    source: 'OA graph network analysis — LLM Wave 23',
    source_url: '',
    detail_en: '58 nodes with 10+ relationships remain at bronze tier. Verification pending.',
    detail_es: '58 nodos con 10+ relaciones permanecen en nivel bronze. Verificación pendiente.',
  },
]
...
export const KEY_ACTORS: Actor[] = [
  ...
  },
  {
    ...
    description_en: 'Called "Angel of Death" by survivors and press. Infiltrated the Madres de Plaza de Mayo, leading to the kidnapping of founders including Azucena Villaflor and the French nuns. Convicted to life imprisonment.',
    description_es: 'Llamado "Ángel de la Muerte" por sobrevivientes y la prensa. Infiltró las Madres de Plaza de Mayo, llevando al secuestro de fundadoras incluyendo Azucena Villaflor y las monjas francesas. Condenado a cadena perpetua.',
    nationality: 'Argentine',
