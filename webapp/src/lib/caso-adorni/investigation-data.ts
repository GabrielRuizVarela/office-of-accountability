...
export const IMPACT_STATS: readonly ImpactStat[] = [
  ...
  { value: '400%', label_es: 'Aumento patrimonial 2023-2024', label_en: 'Patrimony increase 2023-2024', source: 'DDJJ Oficina Anticorrupcion' },
...
export const FACTCHECK_ITEMS: readonly FactcheckItem[] = [
  ...
  { id: 'fc-patrimony-growth', claim_es: 'Patrimonio aumento 400% ($21.6M a $107.9M ARS) en un ano de gobierno', claim_en: 'Patrimony increased 400% ($21.6M to $107.9M ARS) in one year of government', status: 'confirmed', tier: 1, source: 'Chequeado / El Destape', source_url: 'https://chequeado.com/el-explicador/polemica-por-los-viajes-de-manuel-adorni-que-bienes-declaro-el-jefe-de-gabinete/' },
