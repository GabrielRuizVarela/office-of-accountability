...
export const FACTCHECK_ITEMS: readonly FactcheckItem[] = [
  ...
  { id: 'fc-omega-centauri', claim_es: 'Omega Centauri S.A. (CUIT 33719168359) creada en septiembre 2025, misma direccion que Alphacentauri (Esmeralda 288), unico directivo: Augusto Bunge (dueno del Honda Jet LV-HWA). Proposito desconocido.', claim_en: 'Omega Centauri S.A. (CUIT 33719168359) created September 2025, same address as Alphacentauri (Esmeralda 288), sole director: Augusto Bunge (Honda Jet LV-HWA owner). Purpose unknown.', status: 'unconfirmed', tier: 2, source: 'RNS CSV + IGJ', source_url: 'https://datos.jus.gob.ar/dataset/registro-nacional-de-sociedades' },
  ...
  { id: 'fc-enacom', claim_es: 'Imhouse S.A. no aparece en los registros indexados de ENACOM de productoras (Art. 58, Ley 26.522). Ninguna fuente periodistica ni judicial menciona su registracion. De no estar registrada, seria una infraccion regulatoria.', claim_en: 'Imhouse S.A. does not appear in ENACOM indexed producer registry records (Art. 58, Law 26.522). No press or judicial source mentions its registration. If unregistered, this would be a regulatory violation.', status: 'unconfirmed', tier: 2, source: 'ENACOM registry search', source_url: 'https://registros-sca.enacom.gob.ar/productoras/' },
]
