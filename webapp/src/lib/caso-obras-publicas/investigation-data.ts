...
export const FACTCHECK_ITEMS: FactcheckItem[] = [
  ...
  },
  {
    ...
    source_url: 'https://www.cij.gov.ar/nota-33485-Procesan-a-Julio-De-Vido--Jos--Francisco-L-pez-y-Roberto-Baratta-por-cohecho-pasivo.html',
  ...
  },
  {
    ...
    source_url: 'https://www.cij.gov.ar/nota-34805-Causa--Cuadernos---el-juez-Bonadio-proces--a-Cristina-Fern-ndez-de-Kirchner-y-a-m-s-de-100-imputados.html',
  ...
  },
  {
    ...
    source_url: 'https://offshoreleaks.icij.org/nodes/240101089',
  ...
  },
  {
    ...
    source_url: 'https://www.cippec.org/bio/sergio-drucaroff/',
...
export const EVIDENCE_DOCS: EvidenceDoc[] = [
  ...
  },
  {
    ...
    source_url: 'https://www.lanacion.com.ar/tema/los-cuadernos-de-las-coimas-tid65192/',
    verification_status: 'verified',
  },
  {
  ...
  },
  {
    ...
    source_url: 'https://www.infobae.com/politica/2021/11/06/video-el-dia-que-jose-lopez-llevo-bolsos-con-mas-de-9-millones-de-dolares-y-una-ametralladora-a-un-convento/',
    verification_status: 'verified',
  },
]
...
export const GOVERNMENT_RESPONSES: GovernmentResponse[] = [
  ...
  },
  {
    ...
    source_url: 'https://www.boletinoficial.gob.ar/detalleAviso/primera/198769/20181226',
  },
  {
  ...
  },
  {
    ...
    source_url: 'https://www.cij.gov.ar/nota-32770-Tragedia-de-Once--difunden-los-fundamentos-de-la-sentencia-que-conden--a-Julio-De-Vido-.html',
  },
  {
    ...
    source_url: 'https://www.cij.gov.ar/nota-34558-Comenz--el-juicio-oral-a-Cristina-Fern-ndez-de-Kirchner-y-otros-imputados-por-la-causa-Vialidad.html',
  },
]
