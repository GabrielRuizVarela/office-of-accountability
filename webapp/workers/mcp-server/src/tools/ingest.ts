...
// ---------------------------------------------------------------------------
// caso.create — create a new investigation case
// ---------------------------------------------------------------------------
...
registerTool(
  {
    name: 'caso.create',
    description:
      'Create a new investigation case with full schema (InvestigationConfig, SchemaDefinition, default node/rel types). Returns the caso_slug for use with all other tools.',
    inputSchema: {
      type: 'object',
      properties: {
